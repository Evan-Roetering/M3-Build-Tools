...
&emsp; e. name system and make correct system.top file using './make_system_top.sh "\<system name\>"'  
...
15. name system and make correct system.top file using './make_system_top.sh "\<system name\>"'
