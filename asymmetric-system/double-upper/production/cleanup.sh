...
if [[ -f step7_production_trimmed_10.xtc ]]; then
	...
	mkdir -p ../martiniglass
	cp -r ./toppar ../analysis/toppar
	cp -r ./toppar ../martiniglass/toppar
	cp ./system.top ../analysis/system.top 
    cp ./system.top ../martiniglass/system.top
    cp ./step7_production_trimmed_25.xtc ../analysis/trajectory.xtc
    cp ./step7_production_trimmed_10.xtc ../martiniglass/trajectory.xtc
    cp ./step6.7_equilibration.gro ../analysis/topology.gro
    cp ./step6.7_equilibration.gro ../martiniglass/topology.gro
	cp ./step7.${last_step}_production.tpr ../analysis/input.tpr
	cp ./step7.${last_step}_production.tpr ../martiniglass/input.tpr
	cd ../martiniglass
	./martiniglass_auto.sh -g topology.gro -x trajectory.xtc -top system.top -t input.tpr
	cd ../analysis
